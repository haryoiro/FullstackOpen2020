...
const Menu = () => {
  ...
  return (
      <ul style={menuStyles}>
        <li><Link to="/" style={padding}>Anecdotes</Link></li>
        <li><Link to="/create" style={padding}>Create New</Link></li>
        <li><Link to="/about" style={padding}>About</Link></li>
      </ul>
  )
}
...
const Anecdote = ({ anecdotes }) => {
  let { id } = useParams()
  let anecdote = anecdotes.find((n) => n.id === id)
